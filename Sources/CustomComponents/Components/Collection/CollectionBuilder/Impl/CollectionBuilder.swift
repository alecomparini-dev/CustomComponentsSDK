...
public protocol CollectionDelegate: AnyObject {
    //REQUIRED
    func numberOfItemsCallback(_ dockBuilder: CollectionBuilder) -> Int
    func cellCallback(_ dockBuilder: CollectionBuilder, _ index: Int) -> UIView
    func customCellActiveCallback(_ dockBuilder: CollectionBuilder, _ cell: UIView) -> UIView?
    
    //OPTIONAL
    func shouldSelectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int) -> Bool
    func didSelectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int)
    func didDeselectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int)
    func removeItem(_ dockBuilder: CollectionBuilder, _ index: Int)
    func insertItem(_ dockBuilder: CollectionBuilder, _ index: Int)
}


open class CollectionBuilder: BaseBuilder, Collection {
    private weak var delegate: CollectionDelegate?
...
//  MARK: - SET DELEGATE
    @discardableResult
    public func setDelegate(_ delegate: CollectionDelegate) -> Self {
...
extension CollectionBuilder: UICollectionViewDataSource {
...
extension CollectionBuilder: UICollectionViewDelegateFlowLayout {
...
public extension CollectionDelegate {
    func shouldSelectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int) -> Bool { return true }
    func didSelectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int) {}
    func didDeselectItemAt(_ dockBuilder: CollectionBuilder, _ index: Int) {}
    func removeItem(_ dockBuilder: CollectionBuilder, _ index: Int) {}
    func insertItem(_ dockBuilder: CollectionBuilder, _ index: Int) {}
